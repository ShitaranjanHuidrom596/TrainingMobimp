...
namespace Mediqura.BOL.MedStore
{
    public class ItemMasterBO
    {
        public int UpdateItemMasterDetails(ItemMasterData objItemMasterData)
        {
            ...
            try
            {
                ItemMasterDA objItemMasteDA = new ItemMasterDA();
        ...
        public int DeleteItemMasterDetailsByID(ItemMasterData objItemMasterData)
        {
            int result = 0;
            try
            {
                ItemMasterDA objItemMasteDA = new ItemMasterDA();
                result = objItemMasteDA.DeleteItemMasterDetailsByID(objItemMasterData);
            }
            catch (Exception ex)
            {
                PolicyBasedExceptionHandler.HandleException(PolicyBasedExceptionHandler.PolicyName.BusinessProcessExceptionPolicy, ex, "4000001");
