...
{
	public class EmgReturnData : BaseData
	{
		[DataMember]
		...
		[DataMember]
		public string EmergReturnItemDetails { get; set; }
		[DataMember]
		public string PatientDetailsList { get; set; }
		[DataMember]
		public string EmergReturnItemDetailsList { get; set; }
		[DataMember]
		...
		[DataMember]
		public string EmergDrgIssueNo { get; set; }
		[DataMember]
