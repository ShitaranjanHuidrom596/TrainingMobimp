<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="DailyInvoice.aspx.cs" Inherits="Mediqura.Web.Reports.DailyCentresReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <h2 class="breadcumb_cus">Daily Invoice Report</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        ...
                        <asp:Button ID="btnPrintD" runat="server" Class="btn  btn-sm scusbtn" OnClick="btnPrintD_Click" Text="D-Print" />
                    </div>
                </div>
            ...
            <div class="row">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_amount" Style="text-align: left !important;" runat="server"
                                                Text='<%# Eval("DiscountedAmount", "{0:0#.##}") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                    </asp:TemplateField>
                                      <asp:TemplateField>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="row">
                       ...
                       <div class="row" runat="server" id="idtotalbillamount">
                        <div class="col-sm-1">
                        </div>
                        <div class="col-sm-10">
                            <div class="dash_bg_dark">
                                <div class="x_content" style="height: 12vh; width: 100%">
                                    <asp:Label runat="server" Text="TotalBill Amount"></asp:Label>
                                    <br />
                                    <asp:Label runat="server" CssClass=" num_size" ID="lbl_totalbillamount" Style="height: 8vh; width: 100%"></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-1">
