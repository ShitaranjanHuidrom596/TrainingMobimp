    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <asp:Button ID="print_allrpt_btn" runat="server" Visible="false" Class="btn  btn-sm cusbtn" Text="Print Report" OnClick="print_allrpt_btn_Click" />
                </div>
                            ...
                            <div class="pbody">
                                <div class="grid" style="float: left; width: 100%; height: 50vh; overflow: auto">
                                    ...
                                    <asp:GridView ID="GV_PatientList" runat="server" CssClass="table-hover grid_table result-table" AllowPaging="true" AllowCustomPaging="true"
                                        ...
                                        DataKeyNames="ID" AutoGenerateColumns="False" OnRowDataBound="GvPatientTestList_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblreporttypeid" Style="text-align: left !important;" runat="server" Visible="true"
                                                    ...
                                                    <asp:Label ID="lbl_testID" runat="server" Visible="false" Text='<%# Eval("TestID") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lnkEmailPrint" Font-Underline="true" Visible="false" runat="server" CommandName="HPrint" CommandArgument="<%# ((GridViewRow) Container).RowIndex  %>" ValidationGroup="none" OnClientClick="btnConfirm();"><span style="color:red">HPrint</span></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" Width="2%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
