<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="ReferalDoctor.aspx.cs" Inherits="Mediqura.Web.MedUtility.ReferalDoctor" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerreferal" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabreferal" runat="server" CssClass="Tab2" HeaderText="Source Names">
                    <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:DropDownList ID="ddl_referal" AutoPostBack="true" OnSelectedIndexChanged="ddl_referal_SelectedIndexChanged" runat="server" class="form-control input-sm col-sm custextbox">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">Source Name</span>
                                                    ...
                                                    <asp:GridView ID="GvReferal" runat="server" CssClass="table-hover grid_table result-table"
                                                        ...
                                                        <Columns>
                                                           ...
                                                           <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>                                                                  
                                                                    <asp:Label ID="lblreferaltype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("ReferalTypeName") %>'></asp:Label>
                                                                </ItemTemplate>
