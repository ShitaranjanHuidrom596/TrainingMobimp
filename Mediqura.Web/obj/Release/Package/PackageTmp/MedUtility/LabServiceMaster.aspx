...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <h2 class="breadcumb_cus">Add Service Master</h2>
            ...
            <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                <div class="custab-panel" id="panellabgroupmaster">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span10" class="input-group-addon cusspan mandbg" runat="server">Test Group <span
                        ...
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span3" class="input-group-addon cusspan mandbg" runat="server">Test Sub-Group <span
                                    style="color: red">*</span></span>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span11" class="input-group-addon cusspan mandbg" runat="server">Test Code <span
                                    style="color: red">*</span></span>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span1" class="input-group-addon cusspan mandbg" runat="server">Test Name <span
                                    style="color: red">*</span></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span6" class="input-group-addon cusspan mandbg" runat="server">Report Type  <span id="id_reporttpye"
                                ...
                                <asp:DropDownList ID="ddl_reportypes" runat="server" class="form-control input-sm col-sm custextbox">
                                    ...
                                    <asp:ListItem Value="3">Culture </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span8" class="input-group-addon cusspan mandbg" runat="server">Test Type  <span id="Span9"
                                    style="color: red" runat="server">*</span></span>
                                <asp:DropDownList ID="ddl_testype" runat="server" class="form-control input-sm col-sm custextbox">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                         ...
                         <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span7" class="input-group-addon cusspan mandbg" runat="server">Std.Time(in hr) <span
                                    style="color: red">*</span></span>
                                <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                    ID="txt_standardtime">
                                </asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_standardtime" ValidChars="0123456789."></asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                    ...
                    <div class="row">
                          <div class="col-sm-5">
                            <div class="form-group input-group" style="visibility: hidden">
                                <span id="Span4" class="input-group-addon cusspan mandbg" runat="server">Test Center <span
                                    style="color: red">*</span></span>
                        ...
                        <div class="col-sm-3" runat="server" visible="false">
                            <div class="form-group input-group" style="visibility: hidden">
                                <span id="Span2" class="input-group-addon cusspan mandbg" runat="server">Amount(Rs.) <span
                                    style="color: red">*</span></span>
                                <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                    ID="txt_testamount">
                                </asp:TextBox>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group input-group cuspanelbtngrp  pull-right">
                                <asp:Button ID="btnsave" runat="server" Class="btn  btn-sm scusbtn" Text="Add" UseSubmitBehaviour="false" OnClick="btnsave_Click" />
                        ...
                        <div class="col-sm-12">
                            <div class="fixeddiv">
                                <div class="row fixeddiv" id="divmsg3" runat="server">
                                    <asp:Label ID="lblresult" Text="0" runat="server" Height="13px"></asp:Label>
                            ...
                            <div>
                                <div class="pbody">
                                    <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                        <asp:GridView ID="GvLabService" runat="server" CssClass="table-hover grid_table result-table fixed-header-grid" OnPageIndexChanging="GvLabService_PageIndexChanging" AllowPaging="true" AllowCustomPaging="true" PageSize="10"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lbl_testtype" Style="text-align: left !important;" runat="server"
                                                            Text='<%# Eval("TestType") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lbl_testcode" Style="text-align: left !important;" runat="server"
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_standardtime" Style="text-align: left !important;" runat="server"
                                                            Text='<%# Eval("Standardtime") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
