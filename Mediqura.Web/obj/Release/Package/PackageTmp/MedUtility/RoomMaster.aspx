<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="RoomMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.RoomMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerBedmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabBedmaster" runat="server" CssClass="Tab2" HeaderText="Room Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelBedsmaster">
                                <div class="fixeddiv">
                                   ...
                                   <%-- <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Roomcode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_Roomcode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">RoomNo</span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_RoomDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_RoomDescription" ID="FilteredTextBoxExtender2"
                                                runat="server" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                                ValidChars=" " Enabled="True">
                                            </asp:FilteredTextBoxExtender>
                                         </div>
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvOTBed" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvOTBed_PageIndexChanging" OnRowCommand="GvOTBed_RowCommand"  >
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemStyle HorizontalAlign="Left" Width="4%" />
                                                                  ...
                                                                  <%-- <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("BedID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_Bedcode" Style="text-align: left !important;" runat="server" Text='<%# Eval("BedCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>--%>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("RoomID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_roomNo" Style="text-align: left !important;" runat="server"
