<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabUnitMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.LabUnitMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabUnitmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabUnitmaster" runat="server" CssClass="Tab2" HeaderText="Lab Unit Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_labUnitcode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_labUnitcode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_UnitDescription"></asp:TextBox>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvLabUnitType" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvLabUnitType_PageIndexChanging" OnRowCommand="GvLabUnitType_RowCommand">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl.No
                                                                ...
                                                                <ItemTemplate>
                                                                 <%# (Container.DataItemIndex+1)+(GvLabUnitType.PageIndex)*GvLabUnitType.PageSize %>
                                                                 </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("UnitID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_labUnitcode" Style="text-align: left !important;" runat="server" Text='<%# Eval("LabUnitCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_labUnitdescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("LabUnitDescp") %>'></asp:Label>
