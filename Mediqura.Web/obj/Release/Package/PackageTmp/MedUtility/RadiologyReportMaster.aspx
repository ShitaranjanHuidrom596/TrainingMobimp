<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" validateRequest="false" CodeBehind="RadiologyReportMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.RadiologyReportMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainerradioheadermaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabheader" runat="server" CssClass="Tab2" HeaderText="Radiology Report Master">
            <ContentTemplate>
