<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="OTTheaterMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.OTTheaterMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerOTTheatermaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabOTTheatermaster" runat="server" CssClass="Tab2" HeaderText="OT Theater Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_OTTheatercode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_OTTheatercode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_OTtheaterDescription"></asp:TextBox>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvOTTheaterType" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnPageIndexChanging="GvOTTheaterType_PageIndexChanging" OnRowCommand="GvOTTheaterType_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("OTTheaterID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_OTRolecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("OTTheaterCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_OTRoledescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("OTTheaterdescp") %>'></asp:Label>
