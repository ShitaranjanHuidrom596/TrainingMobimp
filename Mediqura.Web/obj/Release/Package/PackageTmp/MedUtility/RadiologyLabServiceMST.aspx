        ...
        <ContentTemplate>
            <div class="custab-panel" id="panellabgroupmaster">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group input-group">
                            <span id="Span5" class="input-group-addon cusspan mandbg" runat="server">Test Center <span
                                style="color: red">*</span></span>
                        ...
                        <div>
                            <div class="pbody">
                                <div class="grid" style="float: left; width: 100%; height: 50vh; overflow: auto">
                                    <asp:GridView ID="GvRadioLab" runat="server" CssClass="table-hover grid_table result-table fixed-header-grid" OnPageIndexChanging="GvRadioLab_PageIndexChanging" AllowCustomPaging="true" AllowPaging="true" PageSize="10" EmptyDataText="No record found..." AutoGenerateColumns="False" Width="100%" HorizontalAlign="Center" OnRowDataBound="GvOPDEmergency_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    Sl.No
                                                ...
                                                <ItemTemplate>
                                                   <%# (Container.DataItemIndex+1)+(GvRadioLab.PageIndex)*GvRadioLab.PageSize %>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                </FooterTemplate>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtrate" Visible="true" onfocus="this.select();" runat="server" Style="text-align: left !important;" Width="70px" MaxLength="7"
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txt_hosshare" onfocus="this.select();" Style="text-align: left !important;" Width="70px" runat="server" MaxLength="7" Text='<%# Eval("HospitalShare", "{0:0#.##}")%>'></asp:TextBox>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txt_consultshare" onfocus="this.select();" Style="text-align: left !important;" MaxLength="7" Width="70px" runat="server" Text='<%# Eval("ConsultantShare", "{0:0#.##}")%>'></asp:TextBox>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txt_reportingshare" onfocus="this.select();" Style="text-align: left !important;" MaxLength="7" Width="70px" runat="server" Text='<%# Eval("Reportingshare", "{0:0#.##}")%>'></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"  style="margin-top: -1.2em;">
                        <asp:Button ID="btnexport" Visible="False"  runat="server" Class="btn  btn-sm cusbtn exprt" Text="Export" OnClick="btnexport_Click" />
                        <div class="form-group input-group cuspanelbtngrp drop-dwn  pull-right">
