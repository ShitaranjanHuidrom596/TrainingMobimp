<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GuestDoctorMST.aspx.cs" Inherits="Mediqura.Web.MedUtility.GuestDoctorMST" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function OnInitializeRequest(sender, args) {
            ...
            <asp:TabContainer ID="tabcontainerGuestDocrmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabGuestDocmaster" runat="server" CssClass="Tab2" HeaderText="Guest Doctor Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelGuestDocmaster">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_GuestDoccode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_GuestDoccode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">Guest Doctor</span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_GuestDocDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_GuestDocDescription" ID="FilteredTextBoxExtender2"
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                           ...
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_GuestDocDescription" ID="FilteredTextBoxExtender4"
                                                runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters"
                                                ValidChars=" " Enabled="True">
                                            </asp:FilteredTextBoxExtender>
                                   ...
                                   <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txtcontact" MaxLength="10"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txtcontact" ID="FilteredTextBoxExtender3"
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvGuestDoc" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnPageIndexChanging="GvGuestDoc_PageIndexChanging" OnRowCommand="GvGuestDoc_RowCommand"
                                                             ...
                                                             <asp:TemplateField>
                                                                 ...
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <asp:Label ID="lbl_GuestDoccode" Style="text-align: left !important;" runat="server" Text='<%# Eval("Code") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_GuestDocName" Style="text-align: left !important;" runat="server"
                                                               ...
                                                               <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_DocDept" Style="text-align: left !important;" runat="server"
