<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="CollectionReport.aspx.cs" Inherits="Mediqura.Web.MIS.CollectionReport" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:DropDownList ID="ddl_account_close" runat="server" class="form-control input-sm col-sm custextbox" AutoPostBack="true" OnSelectedIndexChanged="ddl_account_close_SelectedIndexChanged">
                                                ...
                                                <br />
                                                 <div class="row">
                                                    <div class="col-sm-6">
                                                     ...
                                                     <div class="col-sm-6">
                                                          <asp:Button ID="btnVerify" runat="server" Class="btn  btn-sm cusbtn" Text="Verify" OnClick="btnVerify_Click" />
                                                    </div>
                                                </div>
