<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="AnesthesiaTypeMST.aspx.cs" Inherits="Mediqura.Web.MedOT.AnesthesiaTypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerAnsiamaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabAnsiasmaster" runat="server" CssClass="Tab2" HeaderText="Anesthesia Type Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelAnsiasmaster">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Ansiacode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_Ansiacode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_AnsiaDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_AnsiaDescription" ID="FilteredTextBoxExtender2"
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvAnesthesiaType" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvAnesthesiaType_PageIndexChanging" OnRowCommand="GvAnesthesiaType_RowCommand"  >
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                                 ...
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("AnesThID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_OTRolecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("AnesThCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                 ...
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_OTRoledescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("AnesThdescp") %>'></asp:Label>
