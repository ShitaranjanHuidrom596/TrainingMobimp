...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function confirmDelete() {
            if (confirm("Are you sure you want to delete this Report and Add New?")) {
                return true; // Continue with the postback (i.e., server-side delete)
            } else {
                ...
                <asp:TabPanel ID="tab2" runat="server" CssClass="Tab1" HeaderText="Report Maker">
                    <ContentTemplate>
                        <div class="custab-panel" id="panelSample_collection">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <dx:ASPxRichEdit ID="Richteditor" runat="server"  AutoSaveMode="On" AutoSaveTimeout="00:00:01" workDirectory="~\App_Data\Report"></dx:ASPxRichEdit>
                                </div>
                                <div class="col-sm-2" style="margin-left: -36px;">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <asp:DropDownList runat="server" Visible="true" ID="ddl_templatetype" AutoPostBack="true" OnSelectedIndexChanged="ddl_templatetype_SelectedIndexChanged" class="form-control input-sm col-sm custextbox">
                            ...
                            <div class="row" style="margin-top: 4px">
                                <div class="col-md-10" style="text-align: right">
                                    <p style="color: red">***If Reload Button is click then the Previous Report will be Delete and will be able to add new report***</p>
                                </div>
                                <div class="col-md-2" style="text-align: right">
                                    <asp:Button ID="reload_btn" CssClass="btn btn-sm scusbtn" OnClientClick="return confirmDelete();" OnClick="reload_btn_Click" runat="server" Text="Reload" />
                                </div>
