<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="DependentDocumentUploader.aspx.cs" Inherits="Mediqura.Web.MSB.DependentDocumentUploader" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">

    <asp:TabContainer ID="tabcontainerUploadDepDoc" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabUploadDepDoc" runat="server" CssClass="Tab1" HeaderText="Dependent Document Uploader">
            <ContentTemplate>
                <asp:Panel ID="panel2" runat="server" DefaultButton="btnadd">
                    <div class="custab-panel" id="panel_UploadDepDoc">
                        <div class="fixeddiv">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group input-group">
                                    ...
                                    <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-span"
                                        ID="txtEmpName" OnTextChanged="txtEmpName_TextChanged" AutoPostBack="true"></asp:TextBox>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group input-group">
                                    <span id="Span2" class="input-group-addon cusspan" runat="server">Dependent Name</span>
                                    <asp:DropDownList ID="ddl_Dependent" Class="form-control input-sm col-sm cusmidiumtxtbox"
                                        runat="server">
                                     </asp:DropDownList>
                                </div>
                            </div>
                                                   ...
                                                   <Columns>
                                                        <asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblempno" runat="server" Visible="false" Text='<%# Eval("EmployeeID")%>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_depName" runat="server" Text='<%# Eval("DependentName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_UHID" runat="server" Text='<%# Eval("UHID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                        </asp:TemplateField>
                                                         <asp:TemplateField>
        ...
        <asp:TabPanel ID="tabUploadEmpDoclist" runat="server" CssClass="Tab1" HeaderText="Dependent Document List">
            <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-span"
                                                ID="txt_EmpNameList"  OnTextChanged="txt_EmpNameList_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server"
                                                ServiceMethod="GetEmpdetails" MinimumPrefixLength="1"
                                                CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_EmpNameList"
                                                UseContextKey="True" DelimiterCharacters="" Enabled="True" ServicePath="" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted">
                                            </asp:AutoCompleteExtender>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-sm-4">
                                <div class="form-group input-group">
                                    <span id="Span6" class="input-group-addon cusspan" runat="server">Dependent Name</span>
                                    <asp:DropDownList ID="ddl_dependentList" Class="form-control input-sm col-sm cusmidiumtxtbox"
                                        runat="server">
                                     </asp:DropDownList>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span7" class="input-group-addon cusspan" runat="server">Title</span>

                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txtTittleList"></asp:TextBox>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 45vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="gvUploadList" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table" AllowPaging="true" PageSize="10"
                                                        EmptyDataText="No record found..."
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="codeList" Visible="false" runat="server" Text='<%# Eval("fileID")%>'></asp:Label>
                                                                    <asp:Label ID="lblempnoList" runat="server" Text='<%# Eval("empName")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                            </asp:TemplateField>
                                                             <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_depNameList" runat="server" Text='<%# Eval("DependentName")%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_UHIDList" runat="server" Text='<%# Eval("UHID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                        </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbltitleList" runat="server" Text='<%# Eval("Tittle")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="2%" />
                                                            </asp:TemplateField>
                                                           <asp:TemplateField>
