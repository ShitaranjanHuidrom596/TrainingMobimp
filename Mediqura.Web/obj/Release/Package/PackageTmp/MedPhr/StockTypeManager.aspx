<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="StockTypeManager.aspx.cs" Inherits="Mediqura.Web.MedPhr.StockTypeManager" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontaineritemgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabitemgroupmaster" runat="server" CssClass="Tab2" HeaderText="Sub Stock Manager">
                    <ContentTemplate>
                                                    ...
                                                    <asp:GridView ID="Gvsubtockmanagement" runat="server" CssClass="table-hover grid_table result-table" OnRowDataBound="Gvsubtockmanagement_RowDataBound" AllowPaging="false" PageSize="10"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblstocktypeID" runat="server" Text='<%# Eval("MedSubStockID")%>'></asp:Label>
                                                                    <asp:DropDownList ID="ddl_stocktype" Style="text-align: left !important;" runat="server">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblrequestenableID" runat="server" Text='<%# Eval("MedItemRequestEnable")%>'></asp:Label>
                                                                    <asp:CheckBox ID="chkrequestenable" runat="server"></asp:CheckBox>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblverifyenableID" runat="server" Text='<%# Eval("MedItemVerifyEnable")%>'></asp:Label>
                                                                    <asp:CheckBox ID="chkverifyenable" runat="server"></asp:CheckBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblapproveenableID" runat="server" Text='<%# Eval("MedItemApproveEnable")%>'></asp:Label>
                                                                    <asp:CheckBox ID="chkapproveenable" runat="server"></asp:CheckBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblhandoverenableID" runat="server" Text='<%# Eval("MedItemHandoverEnable")%>'></asp:Label>
                                                                    <asp:CheckBox ID="chkhandoverenable" runat="server"></asp:CheckBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" Width="1%" />
                                                            </asp:TemplateField>
                                                        </Columns>
