<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="PhrIPfinalbill.aspx.cs" Inherits="Mediqura.Web.MedPhr.PhrIPfinalbill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function Printreciept() {
            ...
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=IPFinalBill&BillNo=" + objbillno.value)
        }
        function PrintDuplicatebills(billno) {
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=IPFinalBill&BillNo=" + billno)
        }
    </script>
    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerpatient" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabpanel1" runat="server" HeaderText="Final Bill">
                    <ContentTemplate>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="35"
                                            ID="txt_ipnos" AutoPostBack="True" OnTextChanged="txt_ipnos_TextChanged"></asp:TextBox>
                                        <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server"
                                            ServiceMethod="GetintimtedIPNos" MinimumPrefixLength="1"
                                            CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_ipnos"
                                ...
                                <div id="Div5" class="col-sm-12" runat="server">
                                    <div class="gridview-container-Lab">
                                        <div id="Div8" class="grid" runat="server" style="float: left; width: 100%; height: 30vh; overflow: auto">
                                            ...
                                            <asp:GridView ID="Gvitemlist" runat="server" CssClass="table-hover grid_table result-table"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_iisueno" runat="server" Text='<%# Eval("IPDrgIssueNo") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_ipnolist" AutoPostBack="True"></asp:TextBox>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 40vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="Gvipbilllist" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." PageSize="10" OnRowCommand="Gvipbilllist_RowCommand" AllowPaging="true" AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="Gvipbilllist_PageIndexChanging">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl.No
                                        ...
                                        <div class="pbody">
                                            <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                ...
                                                <asp:GridView ID="GvDiscountRequest" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                    ...
                                                    OnPageIndexChanging="GvDiscountRequest_PageIndexChanging" Width="100%" HorizontalAlign="Center">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                                Sl No.
