<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IndentApproval.aspx.cs" Inherits="Mediqura.Web.MedPhr.IndentApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintIndent_RegnDuplicate(indentno) {
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=Indent_RegnProfile&IndentNo=" + indentno)
        }
        function PrintIndent_Regn() {
            objindno = document.getElementById("<%=txt_indentNumber.ClientID %>")
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=Indent_RegnProfile&IndentNo=" + objindno.value)
        }
    </script>
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerIndent" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabindentRequest" runat="server" CssClass="Tab2" HeaderText="Indent List">
                    <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:DropDownList ID="ddlindentstatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlindentstatus_SelectedIndexChanged" class="form-control input-sm col-sm custextbox">
                                                    ...
                                                    <asp:GridView ID="gvIndentRequest" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_SubstcokID" Visible="false" runat="server" Style="text-align: center !important;" Text='<%# Eval("MedSubStockID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_substock" runat="server" Style="text-align: center !important;" Text='<%# Eval("StockName")%>'></asp:Label>
                                                                </ItemTemplate>
                ...
                <asp:TabPanel ID="TabPanel1" runat="server" CssClass="Tab2" HeaderText="Indent Approval">
                    <ContentTemplate>
                        <div class="custab-panel" id="Div4">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span1" class="input-group-addon cusspan" runat="server">Approved By<span
                                            style="color: red">*</span></span>
                                        <asp:DropDownList ID="ddl_approvedBy" runat="server" class="form-control input-sm col-sm custextbox">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                            ...
                                            <div class="gridview-container">
                                                <div class="grid" style="float: left; width: 100%; overflow: auto">
                                                    <asp:GridView ID="gvIndentDetail" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." Width="100%" HorizontalAlign="Center" OnRowDataBound="gvIndentDetail_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl No.
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkSelect"  runat="server" Text='<%# Eval("ItemName") %>' CommandName="Select" CommandArgument="<%# ((GridViewRow) Container).RowIndex  %>" ValidationGroup="none">
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="7%" Font-Underline="true" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Stock No
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_mainstockID" Visible="false" runat="server" Text='<%# Eval("StockID")%>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_availqty" runat="server" Text='<%# Eval("TotalUnitBalance", "{0:0#.##}")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="lbl_approvedqty" Width="70PX" runat="server" Text='<%# Eval("QtyApproved", "{0:0#.##}")%>'></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="lblremarks" Width="200px" runat="server" Text='<%# Eval("Remarks")%>'></asp:TextBox>
                                                                </ItemTemplate>
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 ">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <asp:Button runat="server" CssClass="btn btn-sm cusbtn scus-sm-btn" ID="btnadd" OnClick="btnadd_Click" OnClientClick="javascript: return confirm('Are you check the physical stock before adding to list. ?');" Text="Add" />
                                                                    </div>
                                                                                ...
                                                                                <asp:GridView ID="GVStockAvailable" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table" OnRowCommand="GVStockAvailable_RowCommand"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lblunit" Style="text-align: left !important;" runat="server" Text='<%# Eval("Unit") %>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lbl_approved" Style="text-align: left !important;" runat="server" Text='<%# Eval("ApprovedQty", "{0:0#.##}") %>'></asp:Label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span18" class="input-group-addon cusspan" runat="server">Indent Status <span
                                            style="color: red">*</span> </span>
                                        <asp:DropDownList ID="ddl_statuss" runat="server" class="form-control input-sm col-sm custextbox">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group cuspanelbtngrp  pull-right">
                                        <asp:Button ID="btnsave" runat="server" Class="btn  btn-sm cusbtn" UseSubmitBehavior="False" Text="Save" OnClick="btn_save_Click" />
