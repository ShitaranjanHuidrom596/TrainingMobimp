<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="RequestTypeMST.aspx.cs" Inherits="Mediqura.Web.MedStore.RequestTypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerRqtypemaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabOTRolesmaster" runat="server" CssClass="Tab2" HeaderText="Request Type Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelRqtypemaster">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Rqtypecode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_Rqtypecode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_RqtypeDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_RqtypeDescription" ID="FilteredTextBoxExtender2"
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvRQtype" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvRQtype_PageIndexChanging" OnRowCommand="GvRQtype_RowCommand"  >
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                                 ...
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("RequestID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_OTRolecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("RequestCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_OTRoledescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("Requestdescp") %>'></asp:Label>
