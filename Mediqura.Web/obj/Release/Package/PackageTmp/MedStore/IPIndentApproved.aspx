<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IPIndentApproved.aspx.cs" Inherits="Mediqura.Web.MedStore.IPIndentApproved" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        function PrintApprovedList() {
            objHndOv = document.getElementById("<%=ddl_HandOver.ClientID %>")
            objApprv = document.getElementById("<%=ddl_approvedBy.ClientID %>")
            objdatefrom = document.getElementById("<%=txt_fromHand.ClientID %>")
            objdateto = document.getElementById("<%=txt_ToHand.ClientID %>")
            window.open("../MedStore/Reports/ReportViewer.aspx?option=IPhandOverList&HandOverTo=" + objHndOv.value + "&ApprovedBy=" + objApprv.value + " &Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value)
        }
        function PrintDuplicateApprv(IndentNo) {
            window.open("../MedStore/Reports/ReportViewer.aspx?option=IPHandover&IndentNo=" + IndentNo)
        }
    </script>
    <asp:TabContainer ID="tabcontainerindentApprovedPHR" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabindentRequest" runat="server" CssClass="Tab2" HeaderText="Patient Indent Approved/Handover">
            <ContentTemplate>
                <div class="custab-panel" id="panelindentRequest">
                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        <ContentTemplate>
                                                    ...
                                                    <asp:GridView ID="gvIndentRequest" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_name" Style="text-align: center !important;" runat="server"
                            ...
                            <div class="row cusrow pad-top ">
                                <label class="gridview-label">Request Detail:</label>
                                <div class="col-sm-12">
                                    <div>
                                        <div class="pbody">
                                            <div class="gridview-container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group cuspanelbtngrp  pull-right">
                                        ...
                                        <%--<asp:Button ID="btn_print" runat="server" UseSubmitBehavior="false" Class="btn  btn-sm  cusbtn" Text="Print" OnClientClick="return PrintIndent_Regn();"  />--%>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group cuspanelbtngrp  pull-right">
                                        ...
                                        <asp:Button ID="btnprint" runat="server" Text="Print" Class="btn  btn-sm cusbtn" OnClientClick="return PrintApprovedList();" />
                                    </div>
                                </div>
                                                    ...
                                                    <asp:GridView ID="gvHandoverlist" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_AppQty" runat="server" Style="text-align: center !important;" Text='<%# Eval("TotApproved")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="3%" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_HndOvQty" runat="server" Style="text-align: center !important;" Text='<%# Eval("TotApproved")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="3%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href="javascript: void(null);" style="color: red; font-size: 12px" onclick="PrintDuplicateApprv('<%# Eval("IndentNo")%>'); return false;">Print</a>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group input-group">
                                        <span id="Span8" class="input-group-addon cusspan" runat="server">Total HandOver Indent</span>
