<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IndentStatusMaster.aspx.cs" Inherits="Mediqura.Web.MedStore.IndentStatusMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerIndentstatusmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabOTRolesmaster" runat="server" CssClass="Tab2" HeaderText="Indent Status Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelIndentstatumaster">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Indentstatucode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_Indentstatucode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_IndentstatuDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_IndentstatuDescription" ID="FilteredTextBoxExtender2"
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvIndentStatus" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvIndentStatus_PageIndexChanging" OnRowCommand="GvIndentStatus_RowCommand"  >
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                                 ...
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <asp:Label ID="lbl_OTRolecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("IndentCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_OTRoledescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("Indentdescp") %>'></asp:Label>
