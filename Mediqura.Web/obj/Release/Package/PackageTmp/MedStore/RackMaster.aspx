<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="RackMaster.aspx.cs" Inherits="Mediqura.Web.MedStore.RackMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabUnitmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabUnitmaster" runat="server" CssClass="Tab2" HeaderText="PHR Rack Master">
                    <ContentTemplate>
