<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="StoreUnitMaster.aspx.cs" Inherits="Mediqura.Web.MedStore.StoreUnitMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
  ...
  <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerStoreUnitmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabStoreUnitmaster" runat="server" CssClass="Tab2" HeaderText="Store Unit Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelStoreUnitmaster">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_StoreUnitcode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_StoreUnitcode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_StoreUnitDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_StoreUnitDescription" ID="FilteredTextBoxExtender2"
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvStoreUnit" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvStoreUnit_PageIndexChanging" OnRowCommand="GvStoreUnit_RowCommand"  >
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                                  ...
                                                                  <ItemTemplate>
                                                                 <%# (Container.DataItemIndex+1)+(GvStoreUnit.PageIndex)*GvStoreUnit.PageSize %>
                                                                   </ItemTemplate>
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("StoreUnitID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_StoreUnitcode" Style="text-align: left !important;" runat="server" Text='<%# Eval("StoreUnitCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_StoreUnitdescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("StoreUnitdescp") %>'></asp:Label>
