<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LookAlikeMST.aspx.cs" Inherits="Mediqura.Web.MedStore.LookAlikeMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerdesignationtypemaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabdesignationtypemaster" runat="server" CssClass="Tab2" HeaderText="PHR Look Alike MST">
                    <ContentTemplate>
