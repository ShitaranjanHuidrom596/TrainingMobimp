<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="PurchaseItemCheckList.aspx.cs" Inherits="Mediqura.Web.MedStore.PurchaseItemCheckList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function PrintPurchaseItemCheckList() {
            ...
            window.open("../MedStore/Reports/ReportViewer.aspx?option=PurchaseItemCheckList&ItemName=" + objitemname.value + "&Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value)
        }
    </script>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:DropDownList ID="ddlstoretype" runat="server" AutoPostBack="true" class="form-control input-sm col-sm custextbox" OnSelectedIndexChanged="ddlstoretype_SelectedIndexChanged">
                                          </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-6">
