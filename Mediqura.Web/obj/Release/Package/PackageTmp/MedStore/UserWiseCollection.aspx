<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="UserWiseCollection.aspx.cs" Inherits="Mediqura.Web.MedStore.UserWiseCollection" %>
										...
										<div>
											<div class="pbody">
												<div class="grid" style="float: left; width: 100%; ">
													...
													<asp:GridView ID="Gv_incomereport" runat="server" CssClass="table-hover grid_table result-table grid"
										...
										<div>
											<div class="pbody">
												<div class="grid" style="float: left; width: 100%;">
													...
													<asp:GridView ID="GV_expensesreport" runat="server" CssClass="table-hover grid_table result-table grid"
														EmptyDataText="No record found..." 
														AutoGenerateColumns="False"  
														Width="100%" HorizontalAlign="Center">
														<Columns>
