<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IPIssueReturn.aspx.cs" Inherits="Mediqura.Web.MedStore.IPIssueReturn" %>
    ...
    <asp:UpdatePanel runat="server" ID="upmain" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerIPIssueReturn" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabIPIssueReturn" runat="server" CssClass="Tab1" HeaderText="IP Return">
                    <ContentTemplate>
