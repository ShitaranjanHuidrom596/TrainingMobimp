<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IndentReceived.aspx.cs" Inherits="Mediqura.Web.MedStore.IndentReceived"  EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        function PrintDuplicateReceived(IndentNo) {
            window.open("../MedStore/Reports/ReportViewer.aspx?option=Received&IndentNo=" + IndentNo)
        }
        function PrintIndentReceived_Regn() {
            objIndentNo = document.getElementById("<%=hdnIndNo.ClientID %>")
            window.open("../MedStore/Reports/ReportViewer.aspx?option=Received&IndentNo=" + objIndentNo.value)
           }
        function PrintReceivedList() {
            objsubstock = document.getElementById("<%=ddl_subStockList.ClientID %>")
            ...
            window.open("../MedStore/Reports/ReportViewer.aspx?option=ReceivedList&SubStock=" + objsubstock.value + "&Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value + "&Received=" + objrecBy.value + "&Status=" + objstat.value)
         }
    </script>
    <asp:TabContainer ID="tabcontainerindentRequest" runat="server" CssClass="Tab" ActiveTabIndex="0"    
        Width="100%">
        <asp:TabPanel ID="Tabindentreceived" runat="server" CssClass="Tab2" HeaderText="Indent received">
            <ContentTemplate>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span19" class="input-group-addon cusspan" runat="server">Sub-Stock Name<span
                                            style="color: red">*</span></span>
                                          <asp:HiddenField ID="hdnIndNo" runat="server" />
                                        <asp:DropDownList ID="ddl_substockrecv" runat="server" AutoPostBack="True" class="form-control input-sm col-sm custextbox">
                                        </asp:DropDownList>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="Span23" class="input-group-addon cusspan" runat="server">Total Received</span>
