<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IPReturnAfterBilling.aspx.cs" Inherits="Mediqura.Web.MedStore.IPReturnAfterBilling" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <asp:UpdatePanel runat="server" ID="upmain" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerIPIssueReturn" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabIPIssueReturn" runat="server" CssClass="Tab1" HeaderText="IP Return After Billing">
                    <ContentTemplate>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-textbox"
                                            ID="txt_IPNo" onfocus="this.select();" AutoPostBack="True" OnTextChanged="txt_IPNo_Textchange"></asp:TextBox>
                                        <asp:AutoCompleteExtender ID="txtipreturnitemSearch_AutoCompleteExtender" runat="server"
                                            ServiceMethod="GetadvanceSearchIPNo" MinimumPrefixLength="1"
                                        ...
                                        <asp:TextBox runat="server" Visible="False" ID="txtipno"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:AutoCompleteExtender ID="IPreturnItem_AutoCompleteExtender" runat="server"
                                        ...
                                        <div class="pbody">
                                            <div class="gridview-container-Lab">
                                                <div class="grid" style="float: left; width: 100%; height: 35vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="gvipreturn" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." OnRowDataBound="gvipreturn_RowDataBound" OnRowCommand="gvipreturn_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_IPDrgIssueNo" Visible="false" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("IPDrgIssueNo") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_rtnqty" runat="server" disabled="disabled" Text='<%# Eval("RtnQuantity")%>'></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                ...
                <asp:TabPanel ID="TabPanel1" runat="server" CssClass="Tab2" HeaderText="IP Return List">
                    <ContentTemplate>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group input-group">
                                                <span id="Span4" class="input-group-addon cus-long-span" runat="server">Patient Details <span
                                                    style="color: red">*</span></span>
                                                <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-textbox"
                                                    ID="txt_tap2IPNO" onfocus="this.select();" AutoPostBack="True" OnTextChanged="txt_tap2IPNO_Textchange"></asp:TextBox>
                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server"
                                                    ServiceMethod="GetadvanceSearchIPPatient" MinimumPrefixLength="1"
                                                    CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_tap2IPNO"
                                                    UseContextKey="True" DelimiterCharacters="" Enabled="True" ServicePath="" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted">
                                                </asp:AutoCompleteExtender>
                                                <asp:FilteredTextBoxExtender TargetControlID="txt_tap2IPNO" ID="FilteredTextBoxExtender3"
                                                    runat="server" ValidChars=". |:-" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                                    Enabled="True">
                                                </asp:FilteredTextBoxExtender>
                                                <asp:TextBox runat="server" Visible="False" ID="txt_tap2IPNOs"></asp:TextBox>
                                                ...
                                                <div class="pbody">
                                                    <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                            <ContentTemplate>
                                                                <asp:GridView ID="gvipreturnlist" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                                    EmptyDataText="No record found..." OnRowCommand="gvipreturnlist_RowCommand"
                                                                    Width="100%" HorizontalAlign="Center">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkbtnPrint" runat="server" CommandName="Print" CommandArgument="<%# ((GridViewRow) Container).RowIndex  %>" ValidationGroup="none">                                                                                   
                                                           ...
                                                           <i class="fa fa-trash-o cus-delete-color"></i>
                                                            ...
                                                            <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="gvipreturnlist" />
                                                            </Triggers>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
