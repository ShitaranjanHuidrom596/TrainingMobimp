<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="MfgCompanyMaster.aspx.cs" Inherits="Mediqura.Web.MedStore.MfgCompanyMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerblockmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabmfgmaster" runat="server" CssClass="Tab2" HeaderText="Mfg Company Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelmaster">
                                <div class="fixeddiv">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="10"
                                                ID="txt_mfgcode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_mfgcode" ID="FilteredTextBoxExtender5"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">Mfg Company Type</span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="35"
                                                ID="txt_mfgcompanytype"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_mfgcompanytype" ID="FilteredTextBoxExtender1"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvMfgCompanyType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvMfgCompanyType_PageIndexChanging" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvMfgCompanyType_RowCommand"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <%# (Container.DataItemIndex+1)+(GvMfgCompanyType.PageIndex)*GvMfgCompanyType.PageSize %>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblmfgcompanytypeID" runat="server" Text='<%# Eval("ID")%>'></asp:Label>
                                                                    <asp:Label ID="lblmfgcompanycode" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("MfgCompanyTypeCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblmfgcompanytype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("MfgCompanyType") %>'></asp:Label>
                                                                </ItemTemplate>
