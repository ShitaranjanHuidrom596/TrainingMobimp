<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabBranchMST.aspx.cs" Inherits="Mediqura.Web.MedHR.RunnerDetailsMst" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerRunnerTax" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabRunnerTaxMST" runat="server" CssClass="Tab2" HeaderText="Branch Master">
                    <ContentTemplate>
