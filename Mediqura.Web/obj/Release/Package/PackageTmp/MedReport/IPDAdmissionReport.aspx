<%@ page title="" language="C#" masterpagefile="~/Mediqura.Master" autoeventwireup="true" codebehind="IPDAdmissionReport.aspx.cs" inherits="Mediqura.Web.MedReport.IPDAdmissionReport" %>
...
<asp:content id="Content1" contentplaceholderid="Mediquraplaceholder" runat="server">
   <script type="text/javascript">
       function PrintAdmissionList() {
           ...
           objadmdoctor = document.getElementById("<%=ddl_doctor.ClientID %>")
           objgender = document.getElementById("<%=ddl_gender.ClientID %>")
           objdatefrom = document.getElementById("<%=txtdatefrom.ClientID %>")
           objdateto = document.getElementById("<%=txtto.ClientID %>")
           objagefrom = document.getElementById("<%=txt_agefrom.ClientID %>")
           objageto = document.getElementById("<%=txt_ageto.ClientID %>")
           objpatienttype = document.getElementById("<%=ddl_patienttype.ClientID %>")
           window.open("../MedReport/Reports/ReportViewer.aspx?option=AdmissionList&Dept=" + objdept.value + "&Doctor=" + objadmdoctor.value + "&Gender=" + objgender.value + "&DateFrom=" + objdatefrom.value + "&DateTo=" + objdateto.value + "&AgeFrom=" + objagefrom.value + "&AgeTo=" + objageto.value + "&PatientType=" + objpatienttype.value)
       }
     </script>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontaineradmission" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
     <asp:TabPanel ID="ipdadmissionlist" runat="server" HeaderText="IPD Admission Report">
                    <ContentTemplate>
                        <div class="custab-panel" id="Div2">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:DropDownList ID="ddl_patienttype" runat="server" class="form-control input-sm col-sm custextbox" >
                                         <asp:ListItem Value="0">--Select--</asp:ListItem>
                                         <asp:ListItem Value="1">DIRECT IPD</asp:ListItem>
                                         <asp:ListItem Value="2">EMG TO WARD</asp:ListItem>
                                         </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span1" class="input-group-addon cusspan" runat="server">Patient's sex</span>
                                        <asp:DropDownList ID="ddl_gender" runat="server" AutoPostBack="true" class="form-control input-sm col-sm custextbox" OnSelectedIndexChanged="ddldepartment_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span3" class="input-group-addon cusspan" runat="server">Age From </span>
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                            ID="txt_agefrom" MaxLength="3"></asp:TextBox>
                                       <asp:FilteredTextBoxExtender TargetControlID="txt_agefrom" ID="FilteredTextBoxExtender1"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span4" class="input-group-addon cusspan" runat="server">Age To  </span>
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="3"
                                            ID="txt_ageto"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender TargetControlID="txt_ageto" ID="FilteredTextBoxExtender2"
                                            runat="server" ValidChars="0123456789"
                                            Enabled="True"></asp:FilteredTextBoxExtender>
                               </div>
                                </div>
