<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="NursingCareReport.aspx.cs" Inherits="Mediqura.Web.MedReport.NursingCareReport" %>
<%@ register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
  <script type="text/javascript">
      function PrintNursingCareList() {
           objserviceid = document.getElementById("<%=ddlward.ClientID %>")
           objdatefrom = document.getElementById("<%=txtdatefrom.ClientID %>")
           objdateto = document.getElementById("<%=txtto.ClientID %>")
          window.open("../MedReport/Reports/ReportViewer.aspx?option=NursingCareList&DateFrom=" + objdatefrom.value + "&DateTo=" + objdateto.value + "&ServiceID=" + objserviceid.value)
       }
       function pageLoad() {
           var options = {
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerpatient" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
     <asp:TabPanel ID="tabpanel2" runat="server" HeaderText="Nursing Care Report">
                    <ContentTemplate>
                                ...
                                <div class="row">
                                  <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="lblsalutation" class="input-group-addon cusspan" runat="server">Ward</span>
                                        <asp:DropDownList ID="ddlward" runat="server" AutoPostBack="true" class="form-control input-sm col-sm custextbox" >
                                        </asp:DropDownList>
                                    </div>
                                  </div> 
                                  <div class="col-sm-4">
                                ...
                                <div class="col-lg-8"></div>
                                  <div class="col-sm-4">
                                        <div class="form-group input-group cuspanelbtngrp  pull-right">
                                            ...
                                            <asp:Button ID="btnprints" runat="server" Class="btn  btn-sm cusbtn" OnClientClick="return PrintNursingCareList();" Text="Print" />
                                                    ...
                                                    <asp:GridView ID="gvnursingcare" runat="server" CssClass="table-hover grid_table result-table" 
                                                        ...
                                                        <Columns>
                                                           ...
                                                           <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblaaddate" runat="server" Text='<%# Eval("AddedDate")%>'></asp:Label>
                                                                </ItemTemplate>
