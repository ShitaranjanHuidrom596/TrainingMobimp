<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="DoctorWisePatientReport.aspx.cs" Inherits="Mediqura.Web.MedReport.DoctorWisePatientReport" %>
...
<asp:content id="Content1" contentplaceholderid="Mediquraplaceholder" runat="server">
   <script type="text/javascript">
       function PrintAdmissionList() {
           ...
           window.open("../MedReport/Reports/ReportViewer.aspx?option=PatientListDoctorWise&DocID=" + objDocId.value + "&DateFrom=" + objdatefrom.value + "&DateTo=" + objdateto.value + "&PatientType=" + objpatienttype.value)
       }
     </script>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontaineradmission" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
            <asp:TabPanel ID="ipdadmissionlist" runat="server" HeaderText="DoctorWise Admission Report">
                    <ContentTemplate>
                        <div class="custab-panel" id="Div2">
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span3" class="input-group-addon cusspan" runat="server">Admission Doctor </span>
