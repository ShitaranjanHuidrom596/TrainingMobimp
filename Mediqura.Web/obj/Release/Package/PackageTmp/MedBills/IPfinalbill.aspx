<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IPfinalbill.aspx.cs" Inherits="Mediqura.Web.MedBills.IPfinalbill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainerpatient" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabpanel1" runat="server" HeaderText="Final Billing">
            <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="lbl_ipno" class="input-group-addon cusspan" runat="server" style="color: red">IP Number <span
                                            style="color: red">*</span></span>
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="35"
                                            ID="txt_ipnumber" AutoPostBack="True" OnTextChanged="txt_ipnumber_TextChanged"></asp:TextBox>
                                        <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server"
                                            ServiceMethod="GetintimtedIPNos" MinimumPrefixLength="1"
                            ...
                            <div id="Div4" class="row cusrow " runat="server">
                                <div id="Div5" class="col-sm-12" runat="server">
                                    <div class="gridview-container-M">
                                        <div id="Div8" class="grid" runat="server" style="float: left; width: 100%; height: 34vh; overflow: auto">
                                            <asp:HiddenField runat="server" ID="upHiddenPostback" />
                                            <asp:GridView ID="Gv_servicelist" runat="server" CssClass="table-hover grid_table result-table" OnRowCommand="Gv_servicelist_RowCommand" OnRowDataBound="Gv_servicelist_RowDataBound"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group input-group pull-right">
                                        <asp:Button ID="btnsave" runat="server" UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.value='Please wait..'" Text="Pay" Class="btn  btn-sm scusbtn"
        ...
        <asp:TabPanel ID="tabpanel2" runat="server" HeaderText="Final Bill List">
            <ContentTemplate>
                        ...
                        <div class="custab-panel" id="Div2">
                            <asp:Panel ID="panel2" runat="server" DefaultButton="btnsearch">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span9" class="input-group-addon cusspan" style="color: red" runat="server">IPNo <span
                                                style="color: red"></span></span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_finalipnumber" AutoPostBack="True"></asp:TextBox>
                                            <asp:AutoCompleteExtender ID="txtContactsSearch_AutoCompleteExtender" runat="server"
                                                ServiceMethod="GetFIPno" MinimumPrefixLength="1"
                                                CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_finalipnumber"
                                                UseContextKey="True" DelimiterCharacters="" Enabled="True" ServicePath="" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted">
                                            </asp:AutoCompleteExtender>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group cuspanelbtngrp  pull-right">
                                            ...
                                            <asp:Button ID="btnprints" Visible="false" runat="server" Class="btn  btn-sm cusbtn" OnClientClick="return PrintCollectionList();" Text="Print" />
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="Gvfinalbillist" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." PageSize="10" OnRowCommand="Gvfinalbillist_RowCommand" AllowPaging="false" AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox CssClass="form-control" ID="txtremarks" runat="server" Text='<%# Eval("Remarks")%>'></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
