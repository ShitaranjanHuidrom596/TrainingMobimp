                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:DropDownList ID="ddl_sourcetype" OnSelectedIndexChanged="ddl_sourcetype_SelectedIndexChanged" AutoPostBack="True" runat="server" class="form-control input-sm col-sm custextbox">
                                 ...
                                 <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span4" class="input-group-addon cusspan" runat="server">Source Name <span
                                            style="color: red">*</span></span>
                                        <asp:DropDownList ID="ddl_sourcename" OnSelectedIndexChanged="ddl_sourcename_SelectedIndexChanged" AutoPostBack="True" runat="server" class="form-control input-sm col-sm custextbox">
                                        </asp:DropDownList>
                                    </div>
                                </div>
<%--                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                            ID="txt_referal" AutoPostBack="True" OnTextChanged="txt_referal_TextChanged" MaxLength="50"></asp:TextBox>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                         <span id="Span89" class="input-group-addon cusspan" runat="server">Group</span>
                                        <asp:ListBox ID="labgrouplist_lbx" class="form-control input-sm col-sm custextbox btn" CssClass="form-control" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span1" class="input-group-addon cusspan" runat="server">Service Category <span
                                            style="color: red">*</span></span>
                                        <asp:DropDownList ID="ddl_servicecategory" AutoPostBack="false" runat="server" class="form-control input-sm col-sm custextbox" OnSelectedIndexChanged="ddl_servicecategory_SelectedIndexChanged">
                                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group cuspanelbtngrp  pull-left">
                                        ...
                                        <asp:Button ID="btnprintrecord" runat="server" OnClick="btnprintrecord_Click" Class="btn  btn-sm scusbtn" Text="Print"  />
                                            ...
                                            <asp:GridView ID="Gv_Collectionlist" runat="server" CssClass="table-hover grid_table result-table"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField Visible="true">
                                                        ...
                                                        <ItemTemplate>
                                                             <asp:Label ID="lblServiceID" visible="false" runat="server" Text='<%# Eval("ServiceID") %>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                               <asp:Label ID="lblTestPrice" Style="text-align: left !important;" runat="server"
                                                                Text='<%# Eval("NetAmount","{0:00.0}") %>'></asp:Label>
                                                        </ItemTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group cuspanelbtngrp  pull-right">
                                        ...
                                        <asp:Button ID="btnexport" runat="server" Visible="false" Class="btn  btn-sm scusbtn" Text="Excel" OnClick="btnexport_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <span id="Span11" class="input-group-addon cusspan" runat="server">Payable Category <span
                                            style="color: red">*</span></span>
                                        <asp:DropDownList ID="ddl_sourcetype2" OnSelectedIndexChanged="ddl_sourcetype2_SelectedIndexChanged" AutoPostBack="True" runat="server" class="form-control input-sm col-sm custextbox">                                         
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group input-group">
                                        <span id="Span12" class="input-group-addon cusspan" runat="server">Referal Name <span
                                            style="color: red">*</span></span>
                                         <asp:DropDownList ID="ddl_sourcename2" OnSelectedIndexChanged="ddl_sourcename2_SelectedIndexChanged" AutoPostBack="True" runat="server" class="form-control input-sm col-sm custextbox">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('[id*=labgrouplist_lbx]').multiselect({
