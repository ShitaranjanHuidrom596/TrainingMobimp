<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="NurseStationMST.aspx.cs" Inherits="Mediqura.Web.MedNurse.NurseStationMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerNurseStatn" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabNurseStatn" runat="server" CssClass="Tab2" HeaderText="Nurse Station Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Stationcode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_Stationcode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_StationDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_StationDescription" ID="FilteredTextBoxExtender2"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvStation" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvStation_PageIndexChanging" OnRowCommand="GvStation_RowCommand">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl.No
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="code" Visible="false" runat="server" Text='<%# Eval("StaionID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_OTRolecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("StationCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_OTRoledescp" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("Stationdescp") %>'></asp:Label>
