<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="NurseStationAddWard.aspx.cs" Inherits="Mediqura.Web.MedNurse.NurseStationAddWard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:updatepanel id="upMains" runat="server" updatemode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerWardToStation" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabWardToStation" runat="server" CssClass="Tab2" HeaderText="Ward To Station MST">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelWardToStation">
                                <div class="fixeddiv">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span3" class="input-group-addon cusspan" runat="server">Station<span
                                                style="color: red">*</span></span>

                                            <asp:DropDownList ID="ddl_station" runat="server" AutoPostBack="true" class="form-control input-sm col-sm custextbox">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span1" class="input-group-addon cusspan" runat="server">Ward<span
                                                style="color: red">*</span></span>
                                    ...
                                    <div>
                                        <div class="pbody">
                                            <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                ...
                                                <asp:GridView ID="GvWardToStn" runat="server" CssClass="table-hover grid_table result-table"  AllowPaging="true" PageSize="10"
                                                    EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvWardToStn_RowCommand" OnPageIndexChanging="GvWardToStn_PageIndexChanging"
