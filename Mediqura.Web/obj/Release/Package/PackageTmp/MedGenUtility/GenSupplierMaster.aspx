<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="SupplierMaster.aspx.cs" Inherits="Mediqura.Web.MedGenUtility.SupplierMaster" %>
                        ...
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelsuppliermaster">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span2" class="input-group-addon cusspan" runat="server">Supplier Name<span
                                                style="color: red">*</span></span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span4" class="input-group-addon cusspan" runat="server">Address</span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="100"
                                                ID="txt_address"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_suppliertype" ID="FilteredTextBoxExtender4"
                                                runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters,Numbers"
                                                FilterMode="ValidChars"
                                                ValidChars=",-/:;. " Enabled="True">
                                            </asp:FilteredTextBoxExtender>
