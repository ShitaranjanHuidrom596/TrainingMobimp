<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GenDeptStockReturnToMain.aspx.cs" Inherits="Mediqura.Web.MedGenStore.GenDeptStockReturnToMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        function PrintReturn() {
            ...
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=ReturnProfile&ReturnNo=" + objReturnNo.value)
        }
        function PrintDuplicateReturn(ReturnNo) {
            objReturnNo = document.getElementById("<%=txt_returnNo.ClientID %>")
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=ReturnProfile&ReturnNo=" + ReturnNo)
        }
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="Span15" class="input-group-addon cusspan" runat="server">Return By <span
                                            style="color: red">*</span></span>
                                        <asp:DropDownList ID="ddl_retrunby" runat="server" class="form-control input-sm col-sm custextbox">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-4">
