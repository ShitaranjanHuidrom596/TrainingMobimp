<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="POApproval.aspx.cs" Inherits="Mediqura.Web.MedGenStore.POApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function PrintPurchaseOrder() {
            ...
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=PurchaseOrder&PONo=" + objpurchaseorder.value)
        }

        function PrintDuplicatePO(PONo) {
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=PurchaseOrder&PONo=" + PONo)
        }
        function PrintPurchaseOrderList(PONo) {
            ...
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=PurchaseOrderList&PONo=" + objpono.value + "&Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value)
        }
                                                    ...
                                                    <asp:GridView ID="gvpurchaseorderlist" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table" OnRowDataBound="gvpurchaseorderlist_RowDataBound"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_tax" runat="server" Text='<%# Eval("Tax")%>'></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_cpperqty" runat="server" Text='<%# Eval("CPPerQty","{0:0#.##}")%>' AutoPostBack="True" OnTextChanged="txt_cpperqty_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
