<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientLogin.aspx.cs" Inherits="Mediqura.Web.PatientLogin" %>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3" >
                ...
                <img src="Images/pdma.jpeg" width="115" height="120" style="margin-top: 20%;" />
                <h3 style="color: #fff; margin-top: 1px;">Patient Padma Diagnostic Centre</h3>
                <p style="color: #fff;">
                    Rims Road Imphal,
                    Manipur - 795001
                </p>
                ...
                <form id="Form1" class="login" runat="server">
                    <div class=" col-md-4 loginbox" style="z-index: 22; border-radius: 8px;">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12 forgotpassword">
                                <span style="font-weight: bold; font-size: 17px; color: #fff;">+91 6009277282, 0385-2413374</span>
                            </div>
                        </div>
