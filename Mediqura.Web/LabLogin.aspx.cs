...
namespace Mediqura.Web
{
    public partial class LabLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ExpiryDate = Convert.ToDateTime("2035/06/01 12:00:00");
        ...
        private void SetLoginToken(UserData objUser)
        {
            try
            {
                ...
                objLoginToken.CollectionCentreID = objUser.objmeduser.CollectionCentreID;
                objLoginToken.CollectionCentreName = objUser.objmeduser.CollectionCentreName;
                ...
                Session["CollectionCentreID"] = objUser.objmeduser.CollectionCentreID;
                Session["CollectionCentreName"] = objUser.objmeduser.CollectionCentreName;
                if (password == "123456")
                {
                    Session["pass"] = "123456";
