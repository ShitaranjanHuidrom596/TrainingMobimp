<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="CommonGroup.aspx.cs" Inherits="Mediqura.Web.MedUtility.CommonGroup" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabgroupmaster" runat="server" CssClass="Tab2" HeaderText="Common Group Master">
                    <ContentTemplate>
