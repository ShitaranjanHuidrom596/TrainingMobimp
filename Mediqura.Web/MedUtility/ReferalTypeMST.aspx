<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="ReferalTypeMST.aspx.cs" Inherits="Mediqura.Web.MedUtility.ReferalType" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerdepartmentmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabdepartmentmaster" runat="server" CssClass="Tab2" HeaderText="Source Type Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="10"
                                                ID="txtReferalTypeCode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtReferalTypeCode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="35"
                                                ID="txtReferalType"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtReferalType" ID="FilteredTextBoxExtender2"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvReferalType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvReferalType_PageIndexChanging" AllowPaging="true" PageSize="10"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvReferalType_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblReferalTypeID" runat="server" Text='<%# Eval("ID")%>'></asp:Label>
                                                                    <asp:Label ID="lbldepartmenttypecode" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("ReferalTypeCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldepartmenttype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("ReferalType") %>'></asp:Label>
                                                                </ItemTemplate>
