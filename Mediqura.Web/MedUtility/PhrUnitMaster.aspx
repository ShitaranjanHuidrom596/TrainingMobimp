<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="PhrUnitMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.PhrUnitMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerdepartmentmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabdepartmentmaster" runat="server" CssClass="Tab2" HeaderText="PHR Unit Master">
                    <ContentTemplate>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvTPAType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvTPAType_PageIndexChanging" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                     <%# (Container.DataItemIndex+1)+(GvTPAType.PageIndex)*GvTPAType.PageSize %>
                                                                </ItemTemplate>
