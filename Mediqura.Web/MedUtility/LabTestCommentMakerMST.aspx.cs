...
{
    public partial class LabTestCommentMakerMST : BasePage
    {
       ...
       private void ddlbind()
        {
            ...
            Commonfunction.Insertzeroitemindex(ddl_labTestName);
        ...
        {
            LabCommentMakerData objRadioReportMaster = new LabCommentMakerData();
            LabCommentMakerBO objRadioBO = new LabCommentMakerBO();
            ...
            List<LabCommentMakerData> objdata = objRadioBO.GetRadioTemplateByID(objRadioReportMaster);
            if (objdata.Count > 0)
            {
