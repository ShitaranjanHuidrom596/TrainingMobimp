<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="OutpatientTypeMST.aspx.cs" Inherits="Mediqura.Web.MedUtility.OutpatientTypeMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerpatienttypemaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabpatienttypemaster" runat="server" CssClass="Tab2" HeaderText="Patient Category Master">
                    <ContentTemplate>
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvPatientType" runat="server" CssClass="table-hover grid_table result-table"
                                                        ...
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvPatientType_RowCommand"
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblpatienttypecode" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("PatientCategoryCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
