<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="TPAMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.TPAMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerdepartmentmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabdepartmentmaster" runat="server" CssClass="Tab2" HeaderText="TPA Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="paneldepartmentmaster">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span6" class="input-group-addon cusspan" runat="server">IsReceivable</span>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvTPAType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvTPAType_PageIndexChanging" AllowPaging="True"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvTPAType_RowCommand"
                                                        Width="100%" HorizontalAlign="Center" OnRowDataBound="GvTPAType_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl.No
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldesc" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("TPADescription") %>'></asp:Label>
                                                                </ItemTemplate>
