<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabMachineMaster.aspx.cs" Inherits="Mediqura.Web.MedUtility.MachineMaster" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:FilteredTextBoxExtender TargetControlID="txtmachinename" ID="FilteredTextBoxExtender2"
                                                runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters,Numbers"
                                                FilterMode="ValidChars"
                                                ValidChars=" ()/:" Enabled="True">
                                            </asp:FilteredTextBoxExtender>
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvLabMachineType" runat="server" CssClass="table-hover grid_table result-table"
                                                        OnPageIndexChanging="GvLabMachineType_PageIndexChanging" AllowPaging="true" PageSize="10"
