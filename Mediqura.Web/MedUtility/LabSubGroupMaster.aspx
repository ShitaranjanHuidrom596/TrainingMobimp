...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <h2 class="breadcumb_cus">Add Test Subgroup</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span4" class="input-group-addon cusspan mandbg" runat="server">Lab Group <span
                        ...
                        <div class="col-sm-3">
                            <div class="form-group input-group">
                                <span id="Span2" class="input-group-addon cusspan mandbg" runat="server">Sub-Group <span
                                    style="color: red">*</span></span>
