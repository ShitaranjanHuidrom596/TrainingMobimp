<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabTestCommentMakerMST.aspx.cs" Inherits="Mediqura.Web.MedUtility.LabTestCommentMakerMST" validateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainerlabTestMST" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabbedassign" runat="server" CssClass="Tab2" HeaderText="Lab Test Comment Master">
            <ContentTemplate>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group input-group">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList AutoPostBack="True" runat="server" ID="ddl_group" class="form-control input-sm col-sm custextbox" OnSelectedIndexChanged="ddl_group_SelectedIndexChanged"></asp:DropDownList>
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:PostBackTrigger ControlID="ddl_group" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </div>
                            </div>
