<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="EmployeeDocTypeMST.aspx.cs" Inherits="Mediqura.Web.MedUtility.EmployeeDocTypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerEmployeeDocTypeMST" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabEmployeeDocTypeMST" runat="server" CssClass="Tab2" HeaderText="Employee Document Type Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelEmployeeDocTypeMST">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="10"
                                                ID="txtEmpDocTypecode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtEmpDocTypecode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="35"
                                                ID="txtEmplDocTypeDesc"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtEmplDocTypeDesc" ID="FilteredTextBoxExtender2"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvEmpDocType" runat="server" CssClass="table-hover grid_table result-table"
                                                        OnPageIndexChanging="GvEmpDocType_PageIndexChanging" AllowPaging="True"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvEmpDocType_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategoryID" Visible="false" runat="server" Text='<%# Eval("EmpDocID")%>'></asp:Label>
                                                                    <asp:Label ID="lblCategorycode" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("EmpDocCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCategorytype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("EmpDocdescp") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
