...
{
    public partial class OutpatientTypeMST : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objPatientTypeMasterData.PatientCategoryCode = txtpatienttypecode.Text == "" ? null : txtpatienttypecode.Text;
                objPatientTypeMasterData.PatientCategory = txtpatienttype.Text == "" ? null : txtpatienttype.Text;
                ...
                int result = objPatientTypeMasterBO.UpdateOutPatientTypeDetails(objPatientTypeMasterData);
        ...
        protected void GvPatientType_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    List<PatientTypeMasterData> GetResult = objPatientTypeMasterBO.GetPatientCategoryDetailsByID(objPatientTypeMasterData);
                    if (GetResult.Count > 0)
                    {
                        txtpatienttypecode.Text = GetResult[0].PatientCategoryCode;
                        txtpatienttype.Text = GetResult[0].PatientCategory;
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    int Result = objPatientTypeMasterBO1.DeletePatientCategoryDetailsByID(objPatientTypeMasterData);
                    if (Result == 1)
                    {
        ...
        private void bindgrid()
        {
            try
            {
                ...
                List<PatientTypeMasterData> lstemp = GetPatientcategory(0);
                if (lstemp.Count > 0)
                {
        ...
        private List<PatientTypeMasterData> GetPatientcategory(int p)
        {
            PatientTypeMasterData objPatientTypeMasterData = new PatientTypeMasterData();
            PatientTypeMasterBO objPatientTypeMasterBO = new PatientTypeMasterBO();
            objPatientTypeMasterData.PatientCategoryCode = txtpatienttypecode.Text == "" ? "" : txtpatienttypecode.Text;
            objPatientTypeMasterData.PatientCategory = txtpatienttype.Text == "" ? "" : txtpatienttype.Text;
            objPatientTypeMasterData.IsActive = ddlstatus.SelectedValue == "0" ? true : false;
            return objPatientTypeMasterBO.SearchPatientCategoryDetails(objPatientTypeMasterData);
        }
        ...
        private void ExportToPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=PatientCategoryDetails.pdf");
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PatientCategoryDetails.xlsx");
        ...
        {
            List<PatientTypeMasterData> PatientTypeDetails = GetPatientcategory(0);
            ...
            foreach (PatientTypeMasterData row in PatientTypeDetails)
            {
                ...
                ExcelSevice.PatientCategoryCode = PatientTypeDetails[i].PatientCategoryCode;
                ExcelSevice.PatientCategory = PatientTypeDetails[i].PatientCategory;
