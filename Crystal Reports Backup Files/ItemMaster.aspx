<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ItemMaster.aspx.cs" Inherits="Mediqura.Web.MedStore.ItemMaster" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontaineritemsubgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabitemsubgroupmaster" runat="server" CssClass="Tab2" HeaderText="Item  Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelitemsubgroupmaster">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="Span5" class="input-group-addon cusspan" runat="server">Unit<span
                                                style="color: red">*</span></span>
                                            <asp:DropDownList ID="ddl_unit" runat="server" AutoPostBack="True" class="form-control input-sm col-sm custextbox">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="Span13" class="input-group-addon cusspan" runat="server">VED Catg. <span
                                                style="color: red">*</span></span>
                                            <asp:DropDownList ID="ddl_vedcatg" runat="server" class="form-control input-sm col-sm custextbox">
