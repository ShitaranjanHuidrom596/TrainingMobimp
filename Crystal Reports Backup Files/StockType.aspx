<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="StockType.aspx.cs" Inherits="Mediqura.Web.MedUtility.StockType" %>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="10"
                                                ID="txt_stocktypecode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_stocktypecode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" MaxLength="35"
                                                ID="txt_stocktype"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_stocktype" ID="FilteredTextBoxExtender2"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvStockType" runat="server" CssClass="table-hover grid_table result-table"
                                                        OnPageIndexChanging="GvStockType_PageIndexChanging" AllowPaging="true" PageSize="10"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvStockType_RowCommand"
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_code" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("StockTypeCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
