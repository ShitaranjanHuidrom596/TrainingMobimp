        ...
        <div class="row">
            <div class="col-sm-12" style="padding: 0; padding-left: 8px;">
                <div class="col-sm-2 padlr2">
                    <div class="dash_bg_dark">
                        <div class="x_content" style="height: 12vh; width: 100%">
                            <asp:Label runat="server" Text="DAILY REGISTRATION"></asp:Label>
                            <br />
                ...
                <div class="col-sm-2 padlr2">
                    <div class="dash_bg_dark">
                        <div class="x_content" style="height: 12vh; width: 100%">
                            <asp:Label runat="server" Text="TOTAL REGISTRATION"></asp:Label>
                            <br />
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 12vh; width: 100%">
                                <asp:Label runat="server" Text="TOTAL BILLING AMOUNT"></asp:Label>
                                <br />
                ...
                <div class="row">
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 13vh; width: 100%">
                                <asp:Label runat="server" Text="TOTAL BILL DUE AMOUNT"></asp:Label>
                                <br />
                    ...
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 13vh; width: 100%">
                                <asp:Label runat="server" Text="DAILY COLLECTED AMOUNT"></asp:Label>
                                <br />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 13vh; width: 100%">
                                <asp:Label runat="server" Text="DAILY DUE BILL AMOUNT"></asp:Label>
                                <br />
                    ...
                    <div class="col-sm-6 padlr2">
                        <div class="dash_bg">
                            <div class="x_content" style="height: 13vh; width: 100%">
                                <asp:Label runat="server" Text="TOTAL COLLECTION CENTER"></asp:Label>
                                <br />
