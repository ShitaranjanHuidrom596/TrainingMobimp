<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GenDeptWiseIndentRequest.aspx.cs" Inherits="Mediqura.Web.MedGenStore.GenDeptWiseIndentRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintRequestList() {
            ...
            window.open("../MedGenStore/Reports/ReportViewer.aspx?option=GenRequestList&StockID=" + objstock.value + "&RequestType=" + objreqType.value + " &Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value + "&IndentNo=" + objIndNo.value + "&RequestBy=" + objreqBy.value + "&indentStatus=" + 0 + "&verstatus=" + 0)
        }
    </script>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_subStock" Visible="false" Text='<%# Eval("DeptID") %>' runat="server"></asp:Label>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txt_ReqQty" ReadOnly="true" runat="server" Text='<%# Eval("ReqdQty")%>' MaxLength="5"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
