<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="RadiologyDashboard.aspx.cs" Inherits="Mediqura.Web.MedLab.RadiologyDashboard" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerRadioDashboard" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabRadioDashboard" runat="server" HeaderText="Radiology Dashboard">
                    <ContentTemplate>
