<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="PhrIPDrugIssue.aspx.cs" Inherits="Mediqura.Web.MedPhr.PhrIPDrugIssue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintIPRecieptDetails(IssueNo) {
            objIssueNo = document.getElementById("<%=txtIssueNo.ClientID %>")
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=PhrIPDrugIssueReciept&IPIssueNo=" + IssueNo)
        }

        function PrintIPReciept() {
            objIssueNo = document.getElementById("<%=txtIssueNo.ClientID %>")
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=PhrIPDrugIssueReciept&IPIssueNo=" + objIssueNo.value)
        }
                        ...
                        <div class="custab-panel" id="panelIPIssue">
                            ...
                            <asp:Panel runat="server" ID="panel1" DefaultButton="btnadd">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="lblNoUnit" class="input-group-addon cusspan" runat="server">Sale in Unit
                                    ...
                                    <div class="col-sm-2">
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                            ReadOnly="true" placeholder="Issue No" ID="txtIssueNo"></asp:TextBox>
                                    </div>
                                </div>
                            </asp:Panel>
                            ...
                            <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            <span id="lblDepositAmount" class="input-group-addon cusspan" runat="server">Advance Deposit  <span style="color: red;">*</span></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group cuspanelbtngrp  pull-right">
                                            ...
                                            <asp:Button ID="btnprint" runat="server" Text="Print" OnClientClick="return PrintIPReciept();" Class="btn  btn-sm scusbtn" />
                                            <asp:Button ID="btnresets" runat="server" Text="Reset" Class="btn  btn-sm scusbtn" OnClick="btnclear_Click" />
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group cuspanelbtngrp  pull-left">
                                        ...
                                        <asp:Button ID="btn_print" runat="server" Visible="false" Text="Print" Class="btn  btn-sm scusbtn" OnClientClick="return PrintIPDrugRecordList();" />
                                            ...
                                            <div class="gridview-container">
                                                <div class="grid" style="float: left; width: 100%; height: 50vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvIPDrugRecordlist" runat="server" AutoGenerateColumns="False" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AllowPaging="false" OnRowCommand="GvIPDrugRecordlist_RowCommand"
                                                        Width="100%" HorizontalAlign="Center">
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center">
                                                                <HeaderTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("ID") %>'></asp:Label>
                                                                    <asp:Label ID="lblDrgRecNo" Visible="true" runat="server" Text='<%# Eval("IPDrgIssueNo") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="text-center">
                                                                ...
                                                                <ItemTemplate>
                                                                    <a href="javascript: void(null);" style="color: red; font-size: 12px" onclick="PrintIPRecieptDetails('<%# Eval("IPDrgIssueNo")%>'); return false;">Print</a>
                                                                </ItemTemplate>
