<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="DayBookList.aspx.cs" Inherits="Mediqura.Web.MedAccount.DayBookList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script>
        function LedgerBookList() {
            ...
            window.open("../MedAccount/Reports/ReportViewer.aspx?option=DayBookList&Branch=" + objbranchid.value + "&Ledger=" + objledgerid.value + "&Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value)
        }
    </script>
    <asp:updatepanel id="upMains" runat="server" updatemode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabContainerAccountGroup" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabPanelAccountGroup" runat="server" HeaderText="Day Book">
                    <contenttemplate>
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                      ...
                                                                      <asp:TemplateField>
                                                                        ...
                                                                        <ItemTemplate>
                                                                       <asp:Label ID="lblvouchertype" Style="text-align: center !important;" runat="server"
                                                                       Text='<%# Eval("VoucherType") %>'></asp:Label>
                                                                       </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                    </asp:TemplateField>
                                                                      <asp:TemplateField>
                                                                        ...
                                                                        <ItemTemplate>
                                                                       <asp:Label ID="lbldebitamt" Style="text-align: center !important;" runat="server"
                                                                       Text='<%# Eval("Debitamount","{0:0#.##}") %>'></asp:Label>
                                                                       </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                    </asp:TemplateField>
                                                                      <asp:TemplateField>
                                                                        ...
                                                                        <ItemTemplate>
                                                                       <asp:Label ID="lblcreditamt" Style="text-align: center !important;" runat="server"
                                                                       Text='<%# Eval("Creditamount","{0:0#.##}") %>'></asp:Label>
                                                                       </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                    </asp:TemplateField>
                                                                      <asp:TemplateField>
