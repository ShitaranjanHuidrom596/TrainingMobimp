<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabTemplate.aspx.cs" Inherits="Mediqura.Web.MedUtility.LabTemplate" %>
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabUnitmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabUnitmaster" runat="server" CssClass="Tab2" HeaderText="Lab Template Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panellabUnitmaster">
                                <div class="fixeddiv">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_labTemplatecode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_labTemplatecode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_TemplateDescription"></asp:TextBox>
                                        </div>
                                    </div>
                                      <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span3" class="input-group-addon cusspan" runat="server">Template Name</span>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_templatename"></asp:TextBox>
                                        </div>
                                    </div>
                               </div>
                                <div class="row">
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvLabTemplateType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvLabTemplateType_PageIndexChanging" AllowPaging="true" PageSize="10" AllowCustomPaging="true"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvLabTemplateType_RowCommand" 
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                           <%# (Container.DataItemIndex+1)+(GvLabTemplateType.PageIndex)*GvLabTemplateType.PageSize %>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_labcode" Style="text-align: left !important;" runat="server" Text='<%# Eval("Code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_labdescp" Style="text-align: left !important;" runat="server"
                                                             ...
                                                             <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_temp" Style="text-align: left !important;" runat="server"
