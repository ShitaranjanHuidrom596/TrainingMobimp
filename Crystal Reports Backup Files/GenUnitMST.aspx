<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GenUnitMST.aspx.cs" Inherits="Mediqura.Web.MedGenUtility.GenUnitMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainergenstrmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabgenstrmaster" runat="server" CssClass="Tab2" HeaderText="GEN Unit Master">
                    <ContentTemplate>
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvUnitMST" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvUnitMST_PageIndexChanging" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvUnitMST_RowCommand"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                     <%# (Container.DataItemIndex+1)+(GvUnitMST.PageIndex)*GvUnitMST.PageSize %>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Visible="false" ID="lblid" runat="server" Text='<%# Eval("StoreUnitID")%>'></asp:Label>
                                                                    <asp:Label ID="lblcode" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("StoreUnitCode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
