<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="TestList.aspx.cs" Inherits="Mediqura.Web.MedReport.Reports.TestList" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabsubgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabsubgroupmaster" runat="server" CssClass="Tab2" HeaderText="Investigation List">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength="100"
                                                ID="txt_labtestname" AutoPostBack="true" OnTextChanged="txt_labtestname_TextChanged"></asp:TextBox>
