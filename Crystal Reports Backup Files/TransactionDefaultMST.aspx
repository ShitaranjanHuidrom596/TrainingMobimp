<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="TransactionDefaultMST.aspx.cs" Inherits="Mediqura.Web.MedAccount.TransactionDefaultMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerDefTrnsMST" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabDefTrnsMST" runat="server" CssClass="Tab2" HeaderText="Transaction Default Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_Trans"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_Trans" ID="FilteredTextBoxExtender1"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvTransaction" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvTransaction_PageIndexChanging" OnRowCommand="GvTransaction_RowCommand" AllowPaging="True" OnRowDataBound="GvTransaction_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    Sl.No
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_Statecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("PaymentMode") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblBankId" Visible="false" runat="server"
                                                                        Text='<%# Eval("BankGroupID") %>'></asp:Label>
