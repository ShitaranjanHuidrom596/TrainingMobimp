<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="POCrossChecking.aspx.cs" Inherits="Mediqura.Web.MedGenStore.POCrossChecking" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
   <script type="text/javascript">
       function PrintPurchaseOrder(PONo) {
           window.open("../MedGenStore/Reports/ReportViewer.aspx?option=POCheckList&PONo=" + PONo)
       }
        </script>
