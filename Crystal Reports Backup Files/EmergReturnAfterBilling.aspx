<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="EmergReturnAfterBilling.aspx.cs" Inherits="Mediqura.Web.MedStore.EmergReturnAfterBilling" %>
    ...
    <asp:UpdatePanel runat="server" ID="upmain" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerIPIssueReturn" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabEmergIssueReturn" runat="server" CssClass="Tab1" HeaderText="Emerg Return After Billing">
                    <ContentTemplate>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:AutoCompleteExtender ID="txtipreturnitemSearch_AutoCompleteExtender" runat="server"
                                            ServiceMethod="GetadvanceSearchEmergNo" MinimumPrefixLength="1"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:AutoCompleteExtender ID="EmregReturnItem_AutoCompleteExtender" runat="server"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group  ">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txtEmergDrgIssueNo" Visible="false" ReadOnly="True"></asp:TextBox>
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group input-group">
                                                ...
                                                <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-textbox"
                                                    ID="txt_tap2EmergNo" onfocus="this.select();" AutoPostBack="True" OnTextChanged="txt_tap2EmergNo_Textchange"></asp:TextBox>
                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server"
                                                    ServiceMethod="GetadvanceSearchEmergPatient" MinimumPrefixLength="1"
                                                    CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_tap2EmergNo"
                                                    UseContextKey="True" DelimiterCharacters="" Enabled="True" ServicePath="" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted">
                                                </asp:AutoCompleteExtender>
                                                <asp:FilteredTextBoxExtender TargetControlID="txt_tap2EmergNo" ID="FilteredTextBoxExtender3"
                                                    runat="server" ValidChars=". |:-" FilterType="Custom, Numbers, UppercaseLetters, LowercaseLetters"
                                                    Enabled="True">
                                                </asp:FilteredTextBoxExtender>
                                                <asp:TextBox runat="server" Visible="False" ID="txt_tap2EmergNos"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group input-group">
                                                ...
                                                <asp:TextBox runat="server" CssClass="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                    ID="txt_Tab2ReturnNo"></asp:TextBox>
                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server"
                                                    ServiceMethod="GetAfterBillingReturnNo" MinimumPrefixLength="1"
                                                    CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_Tab2ReturnNo"
                                                    UseContextKey="True" DelimiterCharacters="" Enabled="True" ServicePath="" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" CompletionListHighlightedItemCssClass="itemHighlighted">
                                                </asp:AutoCompleteExtender>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                           ...
                                                           <i class="fa fa-trash-o cus-delete-color"></i>
                                                            ...
                                                            <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="gvEmergreturnlist" />
                                                            </Triggers>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
