<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="MonthlyInvoice.aspx.cs" Inherits="Mediqura.Web.Reports.MonthlyInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <h2 class="breadcumb_cus">Monthly Invoice Report</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group input-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddl_year" class="form-control input-sm col-sm custextbox">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group input-group">
                        <span id="Span3" class="input-group-addon cusspan" runat="server">Month  <span
                            style="color: red">*</span></span>
                        <asp:DropDownList runat="server" ID="ddl_months" AutoPostBack="true" OnSelectedIndexChanged="ddl_months_SelectedIndexChanged" class="form-control input-sm col-sm custextbox">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group input-group">
                        ...
                        <asp:TextBox runat="server" class="form-control  input-sm col-sm custextbox" AutoPostBack="true" OnTextChanged="txt_to_TextChanged" ID="txt_to"></asp:TextBox>
