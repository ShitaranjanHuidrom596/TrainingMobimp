<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="ICDcodecategory.aspx.cs" Inherits="Mediqura.Web.MedUtility.ICDcodecategory" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
 <script type="text/javascript">
     ...
     <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainernursetypemaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabnursetypemaster" runat="server" CssClass="Tab2" HeaderText="ICD code category">
                    <ContentTemplate>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group input-group">
                                            <span id="Span1" class="input-group-addon cusspan" runat="server">Code category range</span>
                                            ...
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_code" ID="FilteredTextBoxExtender1"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvICDCodeCategory" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvICDCodeCategory_PageIndexChanging" AllowPaging="true" PageSize="10"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvICDCodeCategory_RowCommand"
