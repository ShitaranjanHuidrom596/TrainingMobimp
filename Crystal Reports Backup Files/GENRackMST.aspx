<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GENRackMST.aspx.cs" Inherits="Mediqura.Web.MedGenUtility.GENRackMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabUnitmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabUnitmaster" runat="server" CssClass="Tab2" HeaderText="Store Rack Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_rack"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_rack" ID="FilteredTextBoxExtender1"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvRackType" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvRackType_RowCommand" OnPageIndexChanging="GvRackType_PageIndexChanging" AllowPaging="true" PageSize="10"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_rackid" Visible="false" runat="server" Text='<%# Eval("RackID")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_store" Style="text-align: left !important;" runat="server" Text='<%# Eval("Stock") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_racknumber" Style="text-align: left !important;" runat="server"
