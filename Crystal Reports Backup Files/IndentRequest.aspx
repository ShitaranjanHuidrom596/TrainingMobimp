<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="IndentRequest.aspx.cs" Inherits="Mediqura.Web.MedPhr.IndentRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintRequestList() {
            ...
            window.open("../MedPhr/Reports/ReportViewer.aspx?option=MedRequestList&StockID=" + objstock.value + "&RequestType=" + objreqType.value + " &Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value + "&IndentNo=" + objIndNo.value + "&RequestBy=" + objreqBy.value + "&indentStatus=" + 0 + "&verstatus=" + 0)
        }
    </script>
    <asp:TabContainer ID="tabcontainerpatient" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabpanel2" runat="server" HeaderText="Indent Request">
            <ContentTemplate>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="Span2" class="input-group-addon cusspan" runat="server">Indent Type <span
                                            style="color: red">*</span></span>
                            ...
                            <asp:Panel runat="server" ID="panel3" DefaultButton="btnadd">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-span" MaxLength="100"
                                                ID="txtItemName" placeholder="Search Items.." Font-Italic="true" AutoPostBack="true" OnTextChanged="txtItemName_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group input-group">
                                            <asp:TextBox runat="server" ReadOnly="true" placeholder="Availabilty" CssClass="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <asp:HiddenField runat="server" ID="hdntotalavail" />
                                        <asp:HiddenField runat="server" ID="hdnHSNCode" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_batchno" Visible="false" runat="server" Text='<%# Eval("BatchNo") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_substockavail" Style="text-align: left !important;" runat="server" Text='<%# Eval("TotalAvailUnit", "{0:0#.##}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="lbl_indentqty" Width="100px" Style="text-align: left !important;" runat="server" Text='<%# Eval("ReqdQty") %>'></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="Span14" class="input-group-addon cusspan" runat="server">Total Indent Quantity</span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group">
                                        <span id="Span15" class="input-group-addon cusspan" runat="server">Indented By <span
                                            style="color: red">*</span></span>

                                        <asp:DropDownList ID="ddl_userByDepID" runat="server" class="form-control input-sm col-sm custextbox">
                                        </asp:DropDownList>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group input-group cuspanelbtngrp  pull-right">
                                        <asp:Button ID="btnsave" runat="server" UseSubmitBehavior="false" OnClientClick="this.disabled='true';this.value='Please wait..'" Class="btn  btn-sm  cusbtn" Text="Send Request" OnClick="btn_save_Click" />
