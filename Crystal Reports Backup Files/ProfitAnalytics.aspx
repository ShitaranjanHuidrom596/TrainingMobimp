<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="ProfitAnalytics.aspx.cs" Inherits="Mediqura.Web.MedAnalytics.ProfitAnalytics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainerreferal" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabreferal" runat="server" CssClass="Tab2" HeaderText="Profit Analysis">
            <ContentTemplate>
    ...
    <script>
        ...
        function drawgrap() {
            ...
            config.options.title.text = "Profit Analystics Chart"
