                    ...
                    <ContentTemplate>
                        <div class="custab-panel" id="panelSample_collection">
                                                ...
                                                <asp:GridView ID="Gv_LabResult" runat="server" CssClass="table-hover grid_table result-table"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txt_remarks" TextMode="multiLine" Style="text-align: left !important;" spellcheck="true" Width="200px" Height='<%# Eval("ParmRemarks").ToString().Length*3%>' runat="server" Text='<%# Eval("ParmRemarks") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4" id="divtaken" runat="server">
                                    <div class="form-group input-group">
