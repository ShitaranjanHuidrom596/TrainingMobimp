<%@ page title="" language="C#" masterpagefile="~/Mediqura.Master" autoeventwireup="true" codebehind="InvDashboard.aspx.cs" inherits="Mediqura.Web.MedLab.InvDashboard" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerpatient" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabopdbillingdetails" runat="server" HeaderText="INV Dashboard">
                    <ContentTemplate>
