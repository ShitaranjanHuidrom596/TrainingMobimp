<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="LabSampleTypeMST.aspx.cs" EnableEventValidation="false" Inherits="Mediqura.Web.MedUtility.LabSampleTypeMST" %>
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerlabgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tablabgroupmaster" runat="server" CssClass="Tab2" HeaderText="Lab Sample Type Master">
                    <ContentTemplate>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                                ID="txt_labSamplecode"></asp:TextBox>
                                           <asp:FilteredTextBoxExtender TargetControlID="txt_labSamplecode" ID="FilteredTextBoxExtender1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox"
                                                ID="txt_SampleDescription"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txt_SampleDescription" ID="FilteredTextBoxExtender2"
                                                runat="server" FilterType="Custom,LowercaseLetters,UppercaseLetters"
                                                FilterMode="ValidChars"
                                                ValidChars=" " Enabled="True">
                                            </asp:FilteredTextBoxExtender>
                                            ...
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    <asp:UpdateProgress ID="updateProgress2" runat="server"><ProgressTemplate>
                                                      ...
                                                      <asp:GridView ID="GvLabSampleType" runat="server" CssClass="table-hover grid_table result-table"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvLabSampleType_RowCommand" PageSize="10" AllowPaging="true" AllowCustomPaging="true"
                                                        Width="100%" HorizontalAlign="Center" OnPageIndexChanging="GvLabSampleType_PageIndexChanging">
                                                          <Columns>
                                                             <asp:TemplateField>
                                                                 <HeaderTemplate>
                                                                    Sl.No
                                                                  ...
                                                                  <ItemTemplate>
                                                                  <%# (Container.DataItemIndex+1)+(GvLabSampleType.PageIndex)*GvLabSampleType.PageSize %>
                                                                  </ItemTemplate>
                                                                 <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                   ...
                                                                   <asp:TemplateField>
                                                                    ...
                                                                    <asp:Label ID="lbl_labgrouptypecode" Style="text-align: left !important;" runat="server" Text='<%# Eval("LabSampleTypeCode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField><HeaderTemplate>
                                                                   ...
                                                                   <ItemTemplate>
                                                                    <asp:Label ID="lbl_labgrouptype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("LabSampleType") %>'></asp:Label>
