<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="UrlPage.aspx.cs" Inherits="Mediqura.Web.MedUtility.UrlPage" %>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlpage_Parent" runat="server" AutoPostBack="false" class="form-control input-sm col-sm custextbox">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                                <Triggers>
