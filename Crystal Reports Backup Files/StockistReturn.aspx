<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="StockistReturn.aspx.cs" Inherits="Mediqura.Web.MedStore.StockistReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    <script type="text/javascript">
        ...
        function PrintStockistReturn() {
            ...
            window.open("../MedStore/Reports/ReportViewer.aspx?option=StockistReturn&ReturnNo=" + objreturnno.value)
        }

        function PrintDuplicatebills(returnno) {
            window.open("../MedStore/Reports/ReportViewer.aspx?option=StockistReturn&ReturnNo=" + returnno)
        }
        function PrintStockistItemReturnList() {
            ...
            window.open("../MedStore/Reports/ReportViewer.aspx?option=StockistItemReturnList&Supplier=" + objsupplier.value  + "&Datefrom=" + objdatefrom.value + "&Dateto=" + objdateto.value)
        }
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:TextBox runat="server" Class="form-control input-sm col-sm cus-long-textbox" MaxLength="50"
                                            ID="txt_SupplierName" AutoPostBack="True" OnTextChanged="txt_SupplierName_TextChanged"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txt_SupplierName" ValidChars=" abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"></asp:FilteredTextBoxExtender>
                                        <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server"
                                            ServiceMethod="GetSupplierName" MinimumPrefixLength="1"
                                            CompletionInterval="100" CompletionSetCount="1" TargetControlID="txt_SupplierName"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        ...
                                        <asp:TextBox runat="server" AutoPostBack="True" CssClass="form-control input-sm col-sm custextbox" Style="z-index: 3"
                                            ID="txtPONo" MaxLength="30"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtPONo" ValidChars="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"></asp:FilteredTextBoxExtender>
