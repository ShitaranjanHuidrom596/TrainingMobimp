<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="RadiologyReport.aspx.cs" ValidateRequest="false" Inherits="Mediqura.Web.MedLab.RadiologyReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainer" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabbedassign" runat="server" CssClass="Tab2" HeaderText="Radiology Report">
            <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group input-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddl_patient_type" AutoPostBack="true" OnSelectedIndexChanged="ddl_patient_type_SelectedIndexChanged" class="form-control input-sm col-sm custextbox">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group input-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddl_labsubgroup" AutoPostBack="true" OnSelectedIndexChanged="ddl_labsubgroup_SelectedIndexChanged" class="form-control input-sm col-sm custextbox"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group input-group">
