<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="GenStoreSubGroupMST.aspx.cs" Inherits="Mediqura.Web.MedGenUtility.GenStoreSubGroupMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:TabContainer ID="tabcontainerGenitemsubgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
                Width="100%">
                <asp:TabPanel ID="tabGenitemsubgroupmaster" runat="server" CssClass="Tab2" HeaderText="GEN Item Sub Group Master">
                    <ContentTemplate>
                        <asp:Panel ID="panel2" runat="server" DefaultButton="btnsave">
                            <div class="custab-panel" id="panelGenitemsubgroupmaster">
                                <div class="fixeddiv">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            <span id="Span4" class="input-group-addon cusspan" runat="server">Group </span>
                                            <asp:DropDownList runat="server" ID="Genddlgroup" class="form-control input-sm col-sm custextbox"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength ="10"
                                                ID="Gentxtcode"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="Gentxtcode" ID="FilteredTextBoxExtender5"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group input-group">
                                            ...
                                            <asp:TextBox runat="server" Class="form-control input-sm col-sm custextbox" Style="z-index: 3" MaxLength ="50"
                                                ID="txtGenitemsubgrouptype"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtGenitemsubgrouptype" ID="FilteredTextBoxExtender1"
                                        ...
                                        <div>
                                            <div class="pbody">
                                                <div class="grid" style="float: left; width: 100%; height: 48vh; overflow: auto">
                                                    ...
                                                    <asp:GridView ID="GvGenItemSubGroupType" runat="server" CssClass="table-hover grid_table result-table" OnPageIndexChanging="GvGenItemSubGroupType_PageIndexChanging" AllowPaging="true" PageSize="10"
                                                        EmptyDataText="No record found..." AutoGenerateColumns="False" OnRowCommand="GvGenItemSubGroupType_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblgroup" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("ItemGroupType") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" Width="1%" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblsubgrouptype" Style="text-align: left !important;" runat="server"
                                                                        Text='<%# Eval("ItemSubGroupType") %>'></asp:Label>
                                                                </ItemTemplate>
