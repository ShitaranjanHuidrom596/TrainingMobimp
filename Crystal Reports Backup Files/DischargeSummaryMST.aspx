...
<%@ Page Title="" Language="C#" MasterPageFile="~/Mediqura.Master" AutoEventWireup="true" CodeBehind="DischargeSummaryMST.aspx.cs" ValidateRequest="false" Inherits="Mediqura.Web.MedIPD.DischargeSummaryMST"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Mediquraplaceholder" runat="server">
    ...
    <asp:TabContainer ID="tabcontainerlabgroupmaster" runat="server" CssClass="Tab" ActiveTabIndex="0"
        Width="100%">
        <asp:TabPanel ID="tabbedassign" runat="server" CssClass="Tab2" HeaderText="Discharge Summary MST">
            <ContentTemplate>
                                ...
                                <div class="form-group input-group">
                                    <span id="Span4" class="input-group-addon cusspan" runat="server">Discharge Type </span>
                                      <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                    <asp:DropDownList AutoPostBack="True" runat="server" ID="ddl_DisType" class="form-control input-sm col-sm custextbox" OnSelectedIndexChanged="ddl_DisType_SelectedIndexChanged"></asp:DropDownList>
                                    </ContentTemplate>
                                        <Triggers>
                                            <asp:PostBackTrigger ControlID="ddl_DisType" />
                                        </Triggers>
                                    </asp:UpdatePanel>    
                                </div>
                            </div>
